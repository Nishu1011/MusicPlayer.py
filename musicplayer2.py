...
statusbar = ttk.Label(root, text="Welcome to RAJ Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to RAJ Music Player", anchor=W, font='Arial 8 italic')
...
mixer.init()  
root.title("RAJ Music Player")
ltframe = Frame(root,bg="#0000FF")
ltframe.pack(side=LEFT, padx=30, pady=30)
songplaylistcontainer = Listbox(ltframe,fg='white')
songplaylistcontainer["bg"]="#FF00FF"
